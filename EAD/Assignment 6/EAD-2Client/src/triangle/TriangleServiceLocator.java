...
public class TriangleServiceLocator extends org.apache.axis.client.Service implements triangle.TriangleService {
    ...
    private java.lang.String Triangle_address = "http://localhost:8080/EAD-2/services/Triangle";
    ...
    public triangle.Triangle getTriangle(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            triangle.TriangleSoapBindingStub _stub = new triangle.TriangleSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (triangle.Triangle.class.isAssignableFrom(serviceEndpointInterface)) {
                triangle.TriangleSoapBindingStub _stub = new triangle.TriangleSoapBindingStub(new java.net.URL(Triangle_address), this);
                _stub.setPortName(getTriangleWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://triangle", "TriangleService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://triangle", "Triangle"));
        }
