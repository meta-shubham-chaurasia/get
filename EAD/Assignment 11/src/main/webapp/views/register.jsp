...
<div class="container form-container">
	<form:form modelAttribute="employee" action="/registerUser">
		...
		<div class="custom-control custom-radio">
			<form:radiobutton path="gender" checked="true" id="male" value="male" />
		...
		<form:button type="submit" class="btn btn-primary" id="submit-btn" disabled="true">Register</form:button>
	</form:form>
</div>
<%@ include file="../includes/footer.jsp"%>
<script src="../includes/checkpassword.js"></script>